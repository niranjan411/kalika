...
const brandImages = [
  '/img01.jpeg', '/img02.jpeg', '/img03.jpeg', '/img04.jpeg',
  '/img05.jpeg', '/img06.jpeg', '/img07.jpeg', '/img08.jpeg',
  '/img09.png',  '/img10.jpeg', '/img11.jpeg', '/img12.jpeg',
  '/img13.jpeg', '/img14.jpeg',
];

/* ── Skeleton pulse ── */
const skeletonStyle = {
  background: 'linear-gradient(90deg, var(--parchment) 25%, rgba(139,58,42,0.07) 50%, var(--parchment) 75%)',
  ...
  return (
    <div
      ...
      style={{
        ...
        lineHeight: 0,
        aspectRatio: '1 / 1',        // every tile is a perfect square
      }}
    >
      ...
      <img
        ...
        style={{
          ...
          display: 'block',
          opacity: loaded ? 1 : 0,
          transition: 'opacity 0.45s ease, transform 0.65s cubic-bezier(0.25,0.46,0.45,0.94), filter 0.4s ease',
  ...
  return (
    <>
      ...
      <div style={{
        ...
        <div style={{ width: '36px', height: '1.5px', background: 'var(--terracotta)', opacity: 0.5 }} />
      </div>

      {/* Uniform grid — 4 columns, every cell square */}
      <div
        ...
        >
          <button
            ...
            style={{
              ...
              background: 'transparent', border: '1px solid rgba(201,168,130,0.3)',
              color: 'rgba(201,168,130,0.7)', width: '42px', height: '42px',
          ...
          <button
            ...
            style={{
              ...
              background: 'transparent', border: '1px solid rgba(201,168,130,0.25)',
              color: 'rgba(201,168,130,0.6)', width: '36px', height: '36px',
  ...
  return (
    ...
    >
      <div style={{
        ...
        {/* Skeleton */}
        {!loaded && (
          <div style={{ position: 'absolute', inset: 0, ...skeletonStyle }} />
        )}
        ...
        <img
          ...
          style={{
            ...
            opacity: loaded ? 1 : 0,
            transition: `opacity 0.45s ease, transform 0.75s cubic-bezier(0.25,0.46,0.45,0.94), filter 0.4s ease`,
            transform: hovered ? 'scale(1.06)' : 'scale(1)',
        ...
        {design.images.length > 1 && (
          <div style={{
            ...
            fontFamily: "'Cormorant SC', serif", fontSize: '0.5rem',
            letterSpacing: '0.18em', color: 'var(--cream)',
            background: 'rgba(26,15,10,0.52)', backdropFilter: 'blur(4px)',
        ...
        <div style={{
          ...
          <span style={{
            fontFamily: "'Cormorant SC', serif", fontSize: '0.58rem',
            letterSpacing: '0.35em', textTransform: 'uppercase', color: 'var(--cream)',
            border: '1px solid rgba(245,240,232,0.55)', padding: '0.5rem 1.1rem',
            background: 'rgba(26,15,10,0.25)', backdropFilter: 'blur(6px)',
          }}>
            View Design
          </span>
        </div>
      ...
      <div style={{
        ...
        alignItems: 'center', gap: '0.5rem', flexGrow: 1,
      }}>
        <h3 style={{
          fontFamily: "'Cormorant SC', serif",
          fontSize: 'clamp(0.9rem, 1.4vw, 1.05rem)',
          fontWeight: 400, color: 'var(--deep-brown)',
          lineHeight: 1.25, letterSpacing: '0.04em', minWidth: 0,
        }}>
          {design.title}
        </h3>
        <span style={{
    ...
    <>
      ...
      >
        <div style={{ maxWidth: '1300px', margin: '0 auto' }}>
          ...
          <div style={{
            ...
            <p className="section-label">Clothing Brand</p>
          </div>
          ...
          <div style={{
            ...
            <h2 style={{
              ...
              fontWeight: 300, color: 'var(--deep-brown)',
              lineHeight: 1.0, marginBottom: '0',
            }}>
              Kalika Edit
            </h2>
          </div>
          ...
          <div style={{
            ...
            {[
              ...
              <div key={i} style={{
                ...
                borderColor: 'rgba(139,58,42,0.2)', borderStyle: 'solid',
                borderWidth: 0, ...s,
              }} />
            ))}
            ...
            {!logoLoaded && (
              <div style={{
                width: 'clamp(160px, 22vw, 260px)', height: '80px',
                marginBottom: 'clamp(1.8rem, 3vw, 2.5rem)',
                borderRadius: '4px', ...skeletonStyle,
              }} />
            )}
            ...
            <div style={{
              ...
              marginBottom: logoLoaded ? 'clamp(1.8rem, 3vw, 2.5rem)' : 0,
            }}>
              <img
                src="/logo2.2.png"
                alt="Kalika"
                ...
                style={{
                  ...
                  margin: '0 auto', objectFit: 'contain',
                }}
              />
            </div>
            ...
            <p style={{
              ...
              color: 'var(--mid-brown)', lineHeight: 2,
              ...
              <span style={{
                fontFamily: "'Cormorant SC', serif",
                fontStyle: 'normal', fontSize: '0.65rem',
                letterSpacing: '0.35em', color: 'var(--terracotta)',
      ...
      <style>{`
        ...
        @media (max-width: 320px) {
          ...
          .brand-gallery-grid { grid-template-columns: 1fr !important; }
        }
      `}</style>
    </>
  );
